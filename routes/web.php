...
use App\Http\Controllers\admin\Website_InfoController;
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('website_info/{id}/edit', [Website_InfoController::class, 'edit'])->name('website_info.edit');
    Route::post('website_info/{id}/update', [Website_InfoController::class, 'update'])->name('website_info.update');

    Route::get('contact_us', [Contact_UsController::class, 'index'])->name('contact_us.index');
    Route::get('contact_us/{id}', [Contact_UsController::class, 'show'])->name('contact_us.show');
    Route::post('contact_us/{id}', [Contact_UsController::class, 'read'])->name('contact_us.read');
